        ...
        <>
            ...
            <section id="hero" className="relative min-h-screen flex flex-col items-center pt-32 pb-12 p-8 z-10 overflow-hidden">
                ...
                <div className="z-20 flex flex-row-reverse items-center justify-center gap-8 md:gap-20 w-full max-w-4xl mx-auto flex-grow">
                    {/* Groom Name */}
                    <div className="min-h-[300px] border-l border-white/20 pl-3 md:pl-6 py-4 relative">
                        <motion.div
                            initial={{ scaleY: 0 }}
                            animate={{
                                scaleY: [1, 2.5, 1],
                    ...
                    {/* Bride Name */}
                    <div className="min-h-[300px] mt-16 border-l border-white/20 pl-3 md:pl-6 py-4 relative">
                        <motion.div
                            initial={{ scaleY: 0 }}
                            animate={{
                                scaleY: [1, 2.5, 1],

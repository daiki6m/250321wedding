        ...
        <div className="min-h-screen bg-[#050505] text-white font-zen relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto px-4 py-12 md:p-8 md:pt-12">
                ...
                >
                    ...
                    <div className="text-left leading-loose whitespace-pre-wrap break-words font-handwritten text-[15px] md:text-lg text-gray-200 tracking-normal md:tracking-wide">
                        {guest.message}
                    </div>
